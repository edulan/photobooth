...
RSpec.describe ClipsController, :type => :controller do
  ...
  describe "GET new" do
    it "assigns a new clip as @clip" do
      ...
      expect(assigns(:clip)).to be_a_new(Clip)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created clip as @clip" do
        post :create, {:clip => valid_attributes}, valid_session
        expect(assigns(:clip)).to be_a(Clip)
        expect(assigns(:clip)).to be_persisted
      end

      it "redirects to the created clip" do
        post :create, {:clip => valid_attributes}, valid_session
        expect(response).to redirect_to(Clip.last)
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested clip" do
        clip = Clip.create! valid_attributes
        put :update, {:id => clip.to_param, :clip => new_attributes}, valid_session
        clip.reload
      ...
      it "redirects to the clip" do
        clip = Clip.create! valid_attributes
        put :update, {:id => clip.to_param, :clip => valid_attributes}, valid_session
        expect(response).to redirect_to(clip)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the clip as @clip" do
        clip = Clip.create! valid_attributes
        put :update, {:id => clip.to_param, :clip => invalid_attributes}, valid_session
        expect(assigns(:clip)).to eq(clip)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the clips list" do
      clip = Clip.create! valid_attributes
      delete :destroy, {:id => clip.to_param}, valid_session
      expect(response).to redirect_to(clips_url)
    end
  end
